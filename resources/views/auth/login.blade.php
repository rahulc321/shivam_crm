                ...
                <div class="row justify-content-center">
                   <div class="col-xl-7">
                    <div class="aunthentication-content p-5  rounded text-center">
                        <img src="https://spruko.com/demo/vertix/dist/assets/images/media/media-89.png" alt="img" class="mb-4">
                        <div>
                            <h2 class="fs-4 text-fixed-white lh-base">Wellcome!</h2>
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <input type="text" class="form-control" id="signin-username" placeholder="user name" required name="email">
                                </div>
                                <div class="col-xl-12 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="signin-password" placeholder="password" required name="password">
