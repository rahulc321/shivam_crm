                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header">
                                ...
                                <a class="" href='{{ route("admin.admin.create") }}' style="float:right !important"><span class="badge bg-outline-info">Add Admin</span></a>
                                    ...
                                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                        ...
                                        @foreach($users as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{$value->email}}</td>
                                                <td>
                                                <a class="" href="{{ route('admin.admin.edit', $value->id) }}">
